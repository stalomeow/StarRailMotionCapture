...
namespace HSR.MotionCapture.Net.Protos {
  ...
  #endif
  {
    private static readonly pb::MessageParser<PoseData> _parser = new pb::MessageParser<PoseData>(pb::MessagePool<PoseData>.Get);
    ...
    public void Dispose() {
      ...
      landmarks_.Clear();
      _unknownFields = null;
      pb::MessagePool<PoseData>.Release(this);
    }
